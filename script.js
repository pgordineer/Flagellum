...
function moneyBagsAction() {
  const idx = SAVIOUR_ACTIONS.findIndex(a => a.name === 'Money Bags');
...
function pennyPincherAction() {
  const idx = SAVIOUR_ACTIONS.findIndex(a => a.name === 'Penny Pincher');
  if (saviourUsedActions[idx] || saviourGameOver) return;
...
function tailorAction() {
  const idx = SAVIOUR_ACTIONS.findIndex(a => a.name === 'Tailor');
  if (saviourUsedActions[idx] || saviourGameOver) return;
...
function shrinkRayAction() {
  const idx = SAVIOUR_ACTIONS.findIndex(a => a.name === 'Shrink Ray');
  if (saviourUsedActions[idx] || saviourGameOver) return;
